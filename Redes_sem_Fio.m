...
A = importdata(Entrada);  %Importa os dados a partir de um arquivo de texto
...
elseif x == 1
 ...
 msg_1 = ['O menor custo da trajetória entre "', strjoin(nomes(P_0)),'" e "', strjoin(nomes(P_f)),'" é: ', num2str(e)];
 %disp(msg_1); %Mostra o resultado através de mensagem no prompt de comando
  if e == Inf
 ...
 %disp(msg_2); %Mostra o melhor caminho através de mensagem no prompt de comando
